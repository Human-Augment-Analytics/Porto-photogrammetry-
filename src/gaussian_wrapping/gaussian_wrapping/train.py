...
def training(
    ...
    debug_from, args, 
    depth_order_config, normal_field_config, multiview_config,
    log_interval,
):
    # ---Prepare logger--- 
    ...
    n_pivots_per_gaussian = 2
    
    gaussians = GaussianModel(
        sh_degree=dataset.sh_degree, 
        use_mip_filter=use_mip_filter, 
        learn_occupancy=False,
    ...
    for iteration in range(first_iter, opt.iterations + 1):   
        ...
        with torch.no_grad():
            ...
            (
                ...
                reg_kick_on, normal_field_kick_on, depth_order_kick_on, multiview_kick_on, False,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--rasterizer", type=str, default="ours", choices=["ours"])
